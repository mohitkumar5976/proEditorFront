...
const Stickerbar = () => {
  ...
  return (
    <div
      className={`${
        selectedObject && selectedObject.type === "s" ? "block" : "hidden"
      } flex justify-center items-center gap-x-4 py-1.5 rounded-full px-4 bg-white`}
    >
      ...
      >
        <div
          className={`h w-6 h-6 rounded-full cursor-pointer`}
          style={{
