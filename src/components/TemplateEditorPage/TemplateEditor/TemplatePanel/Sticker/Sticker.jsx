...
const Sticker = ({ obj, objectRef }) => {
  ...
  const isMoving = useSelector((state) => state.common.isMoving);
  ...
  const handleTouchDownActon = (e, obj) => {
    e.preventDefault();
    e.stopPropagation()
  ...
  return (
    <div
      ...
      onTouchStart={(e) => handleTouchDownActon(e, obj)}
      key={obj.id}
